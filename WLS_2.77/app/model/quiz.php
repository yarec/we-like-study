...
class m_quiz extends wls implements dbtable{
	...
	public function exportOne($id,$objPHPExcel){
		...
		$objPHPExcel->getActiveSheet()->setCellValue('A1', $this->cfg->siteName.'_'.$this->il8n['file']['exportExcel']);
		...
		$objPHPExcel->getActiveSheet()->setCellValue('D2', $this->il8n['normal']['title']);

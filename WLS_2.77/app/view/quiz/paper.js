	...
	addQuizBrief : function() {
		var str = 
			"<table width='90%' style='font-size:12px;'>" 
				+ "<tr>" 
					+ "<td width='25%'>" + il8n.normal.name + "</td>"
					+ "<td width='75%'>" + this.paperData.title + "</td>" 
				+ "</tr>" 
				+ "<tr>" 
					+ "<td>" + il8n.quiz.score_top + "</td>" 
					+ "<td>" + this.paperData.score_top + "</td>"
				+ "</tr>" 
				+ "<tr>" 
					+ "<td>" + il8n.quiz.score_avg + "</td>" 
					+ "<td>" + this.paperData.score_avg + "</td>" 
				+ "</tr>" 
				+ "<tr>"
					+ "<td>" + il8n.user.money + "</td>" 
					...
					tb.add({
						...
						handler : function() {
							var win = new Ext.Window({
								...
								width : 500,
								height : 300,
								title : il8n.file.importFile,
								modal : true,
								listeners : {
									'show':function(x){
										var c = document.getElementById('paper_import');   
										c.src =  "importOne.html";
									}
								},

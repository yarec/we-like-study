wls.quiz.exam = Ext.extend(wls.quiz, {
	...
	addQuizBrief : function() {
		var str = "<table width='90%'>" + "<tr>" + "<td>" + il8n.normal.name + "</td>"
				+ "<td>" + this.examData.title + "</td>" + "</tr>" 
				 + "<tr>" + "<td>" + il8n.normal.time_start + "</td>"
				+ "<td>" + this.examData.time_start.substring(0,10) + "</td>" + "</tr>"
				 + "<tr>" + "<td>" + il8n.normal.time_stop + "</td>"
				+ "<td>" + this.examData.time_stop.substring(0,10) + "</td>" + "</tr>"
				 + "<tr>" + "<td>" + il8n.quiz.examPassLine + "</td>"
				+ "<td>" + this.examData.passline + "</td>" + "</tr>"				
				+ "<tr>" + "<td>" + il8n.normal.time_spent
	...
	showResult : function(msg) {
		...
		var str = "<table width='90%'>" 
				...
				+ "<tr>" + "<td>" + il8n.quiz.score + "</td>" + "<td>" + this.mycent + "</td>" + "</tr>" 
				+ "<tr>" + "<td>" + il8n.quiz.Quiz_Paper_Result + "</td>" + "<td>" + passed + "</td>" + "</tr>"
				+ "<tr>" + "<td>" + il8n.quiz.examPassLine + "</td>" + "<td>" + this.examData.passline + "</td>" + "</tr>"
				+ "<tr>" + "<td>" + il8n.quiz.count_right + "</td>" + "<td>" + this.count.right + "</td>" + "</tr>"
				+ "<tr>" + "<td>" + il8n.quiz.count_wrong + "</td>" + "<td>" + this.count.wrong + "</td>" + "</tr>" 
				+ "<tr>" + "<td>" + il8n.quiz.count_giveup + "</td>" + "<td>" + this.count.giveup + "</td>" + "</tr>" 
				+ "<tr>" + "<td>" + il8n.quiz.count_questions + "</td>" + "<td>" + this.count.total + "</td>" + "</tr>"
				+ "</table>";
					...
					columns : [{
								...
								,dataIndex : 'mycent'
						   		,renderer : function(v, meta, record, row_idx, col_idx, store){
						   			...
						   			var d1 = new Date(arr[0]+" "+arr[1]);
						   			if(d1<new Date()){
						   				return '<span style="color:red">'+il8n.quiz.exam_youhavelost+'</span>';
						   			}
					...
					tb.add({
						...
						handler : function() {
							var win = new Ext.Window({
								...
								width : 500,
								height : 300,
								title : il8n.file.importExcel,
								modal : true,
								html : "<iframe src ='importOne.html' width='100%' height='250' frameborder='no' border='0' marginwidth='0' marginheight='0' />"
							});
							win.show(this);
						}
					});
							...
							var win = new Ext.Window({
								...
								listeners : {
									'show':function(x){
										...
										c.src = thisObj.config.AJAXPATH + "?controller=quiz_exam&action=exportOne&id="
										+ pid;
									}
								},
								html : "<iframe width='100%' height='250' frameborder='no' border='0' marginwidth='0' marginheight='0' />"
							});
							win.show(this);
						}
					});
					...
					tb.add({
						...
						handler : function() {
							...
							if (Ext.getCmp(domid).getSelectionModel().selections.items[0].data.mycent!=null) {
								alert(il8n.quiz.exam_already_done);
								return;
							}
							var str = Ext.getCmp(domid).getSelectionModel().selections.items[0].data.time_start;
				   			...
				   			var d1 = new Date(arr[0]+" "+arr[1]);
				   			if(d1<new Date()){
				   				alert(il8n.quiz.exam_youhavelost);
				   				return;
				   			}
					...
					tb.add({
						...
						handler : function() {
							...
							var cm2 = new Ext.grid.ColumnModel({
										...
										columns : [{
												header : il8n.quiz.exam_rank,
												width : 40,
												dataIndex : 'index'
											},{
												header : il8n.quiz.score,
												width : 40,
												dataIndex : 'mycent'
											},{

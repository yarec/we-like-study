wls.quiz.wrong = Ext.extend(wls.quiz, {
	...
	addQuizBrief : function() {
		var str = "<table width='90%'>" + "<tr>" + "<td>"
				+ il8n.quiz.count_questions + "</td>" + "<td>" + this.count.total
				+ "</td>" + "</tr>" + "</table>";
	...
	,
	showResult : function() {
		var str = "<table width='90%'>" + "<tr>" + "<td>" + il8n.quiz.count_right
							...
							win = desktop.createWindow({
								...
								listeners : {
									'show':function(x){
										...
										c.src = "http://localhost:81/app/free/html/quiz/wrong/quiz.html?"
												+ "uid="
												+ uid
												+ '&temp='
												+ Math.random();

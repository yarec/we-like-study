...
class install_yf2jj2kj2zckj2sj extends wls {
	...
	public $ids_level_knowledge = array('52050501','52050502','52050503','52050504','52050505');

	public $id_level_subject = '520505';
	function install_yf2jj2kj2zckj2sj(){
		parent::wls();
		$this->types = array(
			'520505'=> array(
				'su_id'=>6
...
var down = function(){
	$.ajax({
		type: 'post',
		url: 'wls.php?controller=install_yf2jj2kj2zckj2sj&action=down',
		data: {id:ids[index]},

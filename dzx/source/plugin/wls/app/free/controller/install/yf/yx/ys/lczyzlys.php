...
class install_yf_yx_ys_lczyzlys extends install_yf{

	public $path = "E:/TDDOWNLOAD/Discuz_X_12_25/upload/source/plugin/wls3/file/yf/医学类/医师考试/临床执业助理医师/";
	public $url = "http://www.yfzxmn.cn/com/left/left.jsp?so_id=47&su_id=11";
	...
	function install_yf_yx_ys_lczyzlys(){
		$this->type = 'yx_ys_lczyzlys';
...
//		$obj = new m_question();
//		$obj->create();
//		include_once dirname(__FILE__).'/../../../model/quiz/paper/yf/gwy_lczyzlys.php';
		
//		$m = new m_quiz_paper_yf_gwy_lczyzlys();

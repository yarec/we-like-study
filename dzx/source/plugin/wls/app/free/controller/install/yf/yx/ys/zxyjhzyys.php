...
class install_yf_yx_ys_zxyjhzyys extends install_yf{

	public $path = "E:/TDDOWNLOAD/Discuz_X_12_25/upload/source/plugin/wls3/file/yf/医学类/医师考试/中西医结合执业医师/";
	...
	function install_yf_yx_ys_zxyjhzyys(){
		$this->type = 'yx_ys_zxyjhzyys';
...
//		$obj = new m_question();
//		$obj->create();
//		include_once dirname(__FILE__).'/../../../model/quiz/paper/yf/gwy_zxyjhzyys.php';
		
//		$m = new m_quiz_paper_yf_gwy_zxyjhzyys();

...
class install_yf_yx_ws_c1_czys_zysjnl extends install_yf{

	public $path = "E:/TDDOWNLOAD/Discuz_X_12_25/upload/source/plugin/wls3/file/yf/医学类/卫生资格/初级_师/初级药士/专业实践能力/";
	public $url = "http://www.yfzxmn.cn/com/left/left.jsp?so_id=86&su_id=11";
	...
	function install_yf_yx_ws_c1_czys_zysjnl(){
		$this->type = 'yx_ws_c1_czys_zysjnl';
...
//		$obj = new m_question();
//		$obj->create();
//		include_once dirname(__FILE__).'/../../../model/quiz/paper/yf/gwy_gg_gl.php';
		
//		$m = new m_quiz_paper_yf_gwy_gg_gl();

...
class install_yf_cjfg extends install_yf{

	public $path = "E:/TDDOWNLOAD/Discuz_X_12_25/upload/source/plugin/wls3/file/yf/经济类/模拟题试卷/会计从业资格/财经法规与会计职业道德/";
	public $url = "http://www.yfzxmn.cn/com/left/left.jsp?so_id=83&su_id=6";
...
//		$obj = new m_question();
//		$obj->create();
		include_once dirname(__FILE__).'/../../../model/quiz/paper/yf/cjfg.php';

		$m = new m_quiz_paper_yf_cjfg();

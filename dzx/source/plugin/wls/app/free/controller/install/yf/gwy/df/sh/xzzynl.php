...
class install_yf_gwy_df_sh_xzzynl extends install_yf{

	public $path = "E:/TDDOWNLOAD/Discuz_X_12_25/upload/source/plugin/wls3/file/yf/公务员类/模拟题试卷/地方公务员/上海/行政职业能力/";
	public $url = "http://www.yfzxmn.cn/com/left/left.jsp?so_id=200&su_id=5";
	...
	function install_yf_gwy_df_sh_xzzynl(){
...
//		$obj = new m_question();
//		$obj->create();
//		include_once dirname(__FILE__).'/../../../model/quiz/paper/yf/gwy_xzzynl.php';

...
class install_yf_yx_yaos_xyzyys_yxzyzs extends install_yf{

	public $path = "E:/TDDOWNLOAD/Discuz_X_12_25/upload/source/plugin/wls3/file/yf/医学类/执业药师/西药执业药师/药学专业知识1/";
	public $url = "http://www.yfzxmn.cn/com/left/left.jsp?so_id=59&su_id=11";
	...
	function install_yf_yx_yaos_xyzyys_yxzyzs(){
		$this->type = 'yx_yaos_xyzyys_yxzyzs';
...
//		$obj = new m_question();
//		$obj->create();
//		include_once dirname(__FILE__).'/../../../model/quiz/paper/yf/gwy_xyzyys_yxzyzs.php';
		
//		$m = new m_quiz_paper_yf_gwy_xyzyys_yxzyzs();

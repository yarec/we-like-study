 ...
 * SAMPLE USAGE:
 * 
 * this.startMenu = new Ext.ux.StartMenu({ iconCls: 'user', shadow: true, title:
 * get_cookie('memberName') });
 * 
		...
		var buildFooter = function() {
			if (this.footerConfig && this.footerConfig.text) {
				return { // bc
					...
					cn : [{ // footer
						tag : 'div',
						cls : 'ux-startmenu-footer'
								+ (this.footerConfig.iconCls ? ' '
										+ this.footerConfig.iconCls : ''),
						cn : [{
									tag : 'span',
									cls : 'ux-startmenu-footer-text'
								}]
					}]
				};
			} else {
				return {
					tag : 'div',
					cls : 'ux-startmenu-bc ux-startmenu-nofooter'
				};
			}
		};
			...
			cn : [{
						...
						cn : [{ // tr
							...
							cn : [{ // tc
								...
								cn : [{ // header
									tag : 'div',
									cls : 'ux-startmenu-header ' + this.iconCls,
									cn : [{
												tag : 'span',
												cls : 'ux-startmenu-header-text'
											}]
								}]
							}]
						}]

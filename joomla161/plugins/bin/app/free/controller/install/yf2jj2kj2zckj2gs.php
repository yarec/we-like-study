...
class install_yf2jj2kj2zckj2gs extends wls {
	...
	public $ids_level_knowledge = array('52050201','52050202','52050203','52050204','52050205');

	public $id_level_subject = '520502';
	function install_yf2jj2kj2zckj2gs(){
		parent::wls();
		$this->types = array(
			'520502'=> array(
				'su_id'=>6
...
var down = function(){
	$.ajax({
		type: 'post',
		url: 'wls.php?controller=install_yf2jj2kj2zckj2gs&action=down',
		data: {id:ids[index]},

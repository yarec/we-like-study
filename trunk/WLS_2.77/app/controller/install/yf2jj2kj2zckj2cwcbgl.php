...
class install_yf2jj2kj2zckj2cwcbgl extends wls {
	...
	public $ids_level_knowledge = array('52050101','52050102','52050103','52050104','52050105');

	public $id_level_subject = '520501';
	function install_yf2jj2kj2zckj2cwcbgl(){
		parent::wls();
		$this->types = array(
			'520501'=> array(
				'su_id'=>6
...
var down = function(){
	$.ajax({
		type: 'post',
		url: 'wls.php?controller=install_yf2jj2kj2zckj2cwcbgl&action=down',
		data: {id:ids[index]},
...
<div id=\"console\"><div>
	...
	public function getQuestions(){
		...
		if(strpos($this->paperHtmlContent,"一、单项选择题")!=false){				
			...
			if(strpos($this->paperHtmlContent,"判断题")!=false){

...
class install_yf_dsh extends install_yf{

	public $path = "E:/TDDOWNLOAD/Discuz_X_12_25/upload/source/plugin/wls3/file/yf/经济类/模拟题试卷/会计从业资格/初级会计电算化/";
...
//		$obj = new m_question();
//		$obj->create();
//		include_once dirname(__FILE__).'/../../../model/quiz/paper/yf/dsh.php';
//		
//		$m = new m_quiz_paper_yf_dsh();

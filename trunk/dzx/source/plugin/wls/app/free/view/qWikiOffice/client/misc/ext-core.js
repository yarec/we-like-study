...
(function() {
	var h = 0, t = Object.prototype.toString, u = navigator.userAgent
			.toLowerCase(), z = function(e) {
		return e.test(u)
	}, j = document, m = j.compatMode == "CSS1Compat", B = z(/opera/), i = z(/chrome/), v = z(/webkit/), y = !i
			&& z(/safari/), g = y && z(/applewebkit\/4/), b = y
			&& z(/version\/3/), C = y && z(/version\/4/), s = !B && z(/msie/), q = s
			&& z(/msie 7/), p = s && z(/msie 8/), r = s && !q && !p, o = !v
			&& z(/gecko/), d = o && z(/rv:1\.8/), a = o && z(/rv:1\.9/), w = s
			&& !m, A = z(/windows|win32/), l = z(/macintosh|mac os x/), k = z(/adobeair/), n = z(/linux/), c = /^https/i
	...
	Ext.apply(Ext, {
		...
		id : function(e, D) {
			return (e = Ext.getDom(e) || {}).id = e.id || (D || "ext-gen")
					+ (++h)
		},
		extend : function() {
			var D = function(F) {
...
(function() {
	...
	(function() {
		...
		Ext.lib.Dom = {
			...
			getDocumentHeight : function() {
				return g(!e
								? h.body.scrollHeight
								: h.documentElement.scrollHeight, this
								.getViewportHeight())
			},
			getDocumentWidth : function() {
				return g(!e
								? h.body.scrollWidth
								: h.documentElement.scrollWidth, this
								.getViewportWidth())
			},
			...
			getXY : function(l) {
				var k, r, t, w, m, n, v = 0, s = 0, u, j, o = (h.body || h.documentElement), q = [
						0, 0];
				l = Ext.getDom(l);
				if (l != o) {
					if (l.getBoundingClientRect) {
						...
						while (k) {
							...
							if (Ext.isGecko) {
								s += w = i(r.getStyle("borderTopWidth"), 10)
										|| 0;
								v += m = i(r.getStyle("borderLeftWidth"), 10)
										|| 0;
	...
	Ext.lib.Event = function() {
			...
			if (!D) {
				...
				for (L = 0, I = q.length; L < I; L++) {
					...
					if (J && (M = H.getElementById(J.id))) {
						if (!J.checkReady || x || M.nextSibling
								|| (H && H.body)) {
							M = J.override ? (J.override === true
									? J.obj
									: J.override) : M;
							J.fn.call(M, J.obj);
							q.remove(J)
		...
		var z = {
			...
			getRelatedTarget : function(I) {
				I = I.browserEvent || I;
				return this.resolveTextNode(I.relatedTarget
						|| (I.type == G ? I.toElement : I.type == A
								? I.fromElement
								: null))
			},
			getPageX : function(I) {
	...
	Ext.lib.Ajax = function() {
		...
		var l = {
			...
			serializeForm : function(s) {
				var t = s.elements
						|| (document.forms[s] || Ext.getDom(s)).elements, z = false, y = encodeURIComponent, w, A, r, u, v = "", x;
					...
					if (!B.disabled && r) {
						if (/select-(one|multiple)/i.test(x)) {
							...
							if (!/file|undefined|reset|button/i.test(x)) {
								if (!(/radio|checkbox/i.test(x) && !B.checked)
										&& !(x == "submit" && z)) {
									v += y(r) + "=" + y(B.value) + "&";
									z = /submit/i.test(x)
								}
	...
	(function() {
		var h = Ext.lib, j = /width|height|opacity|padding/i, g = /^((width|height)|(top|left))$/, d = /width|height|top$|bottom$|left$|right$/i, i = /\d+(em|%|en|ex|pt|in|cm|mm|pc)$/i, k = function(
				l) {
		...
		h.AnimBase.prototype = {
			...
			getAttr : function(l) {
				...
				return (!!(m[2]) || (n.getStyle("position") == "absolute" && !!(m[3])))
						? n.dom["offset" + m[0].charAt(0).toUpperCase()
								+ m[0].substr(1)]
						: 0
			},
			...
			init : function(m, q, p, l) {
				...
				var r = function() {
					var w = this;
					w.onTween.fire({
								duration : e() - w.startTime,
								curFrame : w.curFrame
							});
					var x = w.runAttrs;
					for (var v in x) {
						this.setAttr(v, w.doMethod(v, x[v].start, x[v].end),
								x[v].unit)
					}
					++o
				};
				var n = function() {
					var v = this, x = (e() - v.startTime) / 1000, w = {
						duration : x,
						frames : o,
						fps : o / x
					};
		...
		Ext.lib.AnimMgr = new function() {
			...
			var o = function(s) {
				var w = s.totalFrames, v = s.curFrame, u = s.duration, t = (v
						* u * 1000 / w), r = (e() - s.startTime), x = 0;
				if (r < u * 1000) {
		...
		(function() {
			...
			Ext.apply(h.Motion.prototype, {
				...
				getAttr : function(p) {
					...
					return m.test(p)
							? [q.call(r, "left"), q.call(r, "top")]
							: q.call(r, p)
				},
				doMethod : function(p, s, q) {
					var r = this;
					return m.test(p) ? h.Bezier.getPosition(r.runAttrs[p], r
									.method(r.curFrame, 0, 100, r.totalFrames)
									/ 100) : o.doMethod.call(r, p, s, q)
				},
				setRunAttr : function(w) {
					if (m.test(w)) {
						var y = this, r = this.el, B = this.attributes.points, u = B.control
								|| [], z = B.from, A = B.to, x = B.by, C = h.Dom, q, t, s, v, p;
	...
	(function() {
		...
		Ext.apply(g.Easing, {
			...
			easeBothStrong : function(l, k, n, m) {
				return ((l /= m / 2) < 1) ? n / 2 * l * l * l * l + k : -n / 2
						* ((l -= 2) * l * l * l - 2) + k
			},
			elasticIn : function(m, k, r, q, l, o) {
				...
				return -(l * h(2, 10 * (m -= 1)) * e((m * q - n) * (2 * j) / o))
						+ k
			},
			...
			elasticBoth : function(m, k, r, q, l, o) {
				...
				return m < 1 ? -0.5
						* (l * h(2, 10 * (m -= 1)) * e((m * q - n) * (2 * j)
								/ o)) + k : l * h(2, -10 * (m -= 1))
						* e((m * q - n) * (2 * j) / o) * 0.5 + r + k
			},
			...
			bounceOut : function(l, k, n, m) {
				if ((l /= m) < (1 / 2.75)) {
					...
					if (l < (2 / 2.75)) {
						return n * (7.5625 * (l -= (1.5 / 2.75)) * l + 0.75)
								+ k
					} else {
						if (l < (2.5 / 2.75)) {
							return n
			...
			bounceBoth : function(l, k, n, m) {
				return (l < m / 2) ? g.Easing.bounceIn(l * 2, 0, n, m) * 0.5
						+ k : g.Easing.bounceOut(l * 2 - m, 0, n, m) * 0.5 + n
						* 0.5 + k
			}
		})
	})();
	(function() {
		...
		var k = i.ColorAnim.superclass, j = /color$/i, g = /^transparent|rgba\(0, 0, 0, 0\)$/, m = /^rgb\(([0-9]+)\s*,\s*([0-9]+)\s*,\s*([0-9]+)\)$/i, d = /^#?([0-9A-F]{2})([0-9A-F]{2})([0-9A-F]{2})$/i, e = /^#?([0-9A-F]{1})([0-9A-F]{1})([0-9A-F]{1})$/i, h = function(
				n) {
	...
	(function() {
		...
		Ext.apply(d.Scroll.prototype, {
					doMethod : function(h, n, i) {
						...
						if (h == e) {
							l = [k.method(m, n[0], i[0] - n[0], j),
									k.method(m, n[1], i[1] - n[1], j)]
						} else {
		...
		fireEvent : function() {
			...
			if (p.eventsSuspended === h) {
				...
				if (a(s) && s.bubble) {
					...
					if (t && t.enableBubble) {
						if (!t.events[o] || !Ext.isObject(t.events[o])
								|| !t.events[o].bubble) {
							t.enableBubble(o)
						}
			...
			if (a(p)) {
				...
				for (q in n) {
					...
					if (!r.filterOptRe.test(q)) {
						r.addListener(q, v.fn || v, v.scope || n.scope, v.fn
										? v
										: n)
					}
				}
		...
		fire : function() {
			...
			if (m > 0) {
				...
				for (; p < m; p++) {
					n = q[p];
					if (n
							&& n.fireFn.apply(n.scope || r.obj || window, o) === j) {
						return (r.firing = j)
					}
				}
			}
...
(function() {
	...
	h.prototype = {
		...
		contains : function(o) {
			return !o ? false : Ext.lib.Dom.isAncestor(this.dom, o.dom
							? o.dom
							: o)
		},
	...
	function l() {
		if (!Ext.enableGarbageCollector) {
			...
			for (p in b) {
				...
				u = r.dom;
				if (!u || !u.parentNode
						|| (!u.offsetParent && !j.getElementById(p))) {
...
Ext.Element.addMethods(function() {
	var h = {}, x = /(-[a-z])/gi, b = {}, s = document.defaultView, u = Ext.isIE
			? "styleFloat"
			: "cssFloat", C = /alpha\(opacity=(.*)\)/i, l = /^\s+|\s+$/g, A = Ext.Element, d = "padding", c = "margin", y = "border", t = "-left", q = "-right", w = "-top", o = "-bottom", j = "-width", r = Math, z = "hidden", e = "isClipped", k = "overflow", n = "overflow-x", m = "overflow-y", B = "originalClip", i = {
		l : y + t + j,
		r : y + q + j,
		t : y + w + j,
		b : y + o + j
	...
	return {
		...
		removeClass : function(H) {
			...
			if (I.dom && I.dom.className) {
				for (var G = 0, E = H.length; G < E; G++) {
					F = H[G];
					if (F) {
						I.dom.className = I.dom.className.replace(b[F] = b[F]
										|| new RegExp("(?:^|\\s+)" + F
														+ "(?:\\s+|$)", "g"),
								" ")
					}
		...
		hasClass : function(E) {
			return E
					&& (" " + this.dom.className + " ").indexOf(" " + E + " ") != -1
		},
		...
		getStyle : function() {
			return s && s.getComputedStyle ? function(K) {
				...
				F = (E = H.style[K]) ? E : (G = s.getComputedStyle(H, ""))
						? G[K]
						: null;
				if (J) {
					if (F == "rgba(0, 0, 0, 0)") {
		...
		setOpacity : function(F, E) {
			...
			if (!E || !I.anim) {
				if (Ext.isIE) {
					var H = F < 1 ? "alpha(opacity=" + F * 100 + ")" : "", J = G.filter
							.replace(C, "").replace(l, "");
					G.zoom = 1;
				...
				I.anim({
						...
						}, I.preanim(arguments, 1), null, 0.35, "easeIn")
			}
			return I
		},
		...
		getHeight : function(G) {
			var F = this, I = F.dom, H = Ext.isIE
					&& F.isStyle("display", "none"), E = r.max(I.offsetHeight,
					H ? 0 : I.clientHeight)
					|| 0;
		...
		getWidth : function(F) {
			var G = this, I = G.dom, H = Ext.isIE
					&& G.isStyle("display", "none"), E = r.max(I.offsetWidth, H
							? 0
							: I.clientWidth)
					|| 0;
		...
		setWidth : function(F, E) {
			var G = this;
			F = G.adjustWidth(F);
			!E || !G.anim ? G.dom.style.width = G.addUnits(F) : G.anim({
						width : {
							to : F
						}
					}, G.preanim(arguments, 1));
			return G
		},
		setHeight : function(E, F) {
			var G = this;
			E = G.adjustHeight(E);
			!F || !G.anim ? G.dom.style.height = G.addUnits(E) : G.anim({
						height : {
							to : E
						}
					}, G.preanim(arguments, 1));
...
(function() {
	...
	Ext.Element.addMethods({
				...
				setX : function(l, m) {
					return this.setXY([l, this.getY()], this.animTest(
									arguments, m, 1))
				},
				setY : function(m, l) {
					return this.setXY([this.getX(), m], this.animTest(
									arguments, l, 1))
				},
				setLeft : function(l) {
				...
				getLeft : function(l) {
					return !l ? this.getX() : parseInt(this.getStyle(b), 10)
							|| 0
				},
				getRight : function(l) {
					var m = this;
				...
				getTop : function(l) {
					return !l ? this.getY() : parseInt(this.getStyle(d), 10)
							|| 0
				},
...
Ext.Element.addMethods(function() {
	...
	return {
		...
		anim : function(o, p, m, r, n, l) {
			m = m || "run";
			p = p || {};
			var q = this, s = Ext.lib.Anim[m](q.dom, o, (p.duration || r)
							|| 0.35, (p.easing || n) || "easeOut", function() {
						if (l) {
							l.call(q)
						}
						if (p.callback) {
	...
	Ext.Fx = {
		...
		slideIn : function(H, E) {
			...
			J.queueFx(E, function() {
				...
				I = p(G).switchStatements(H.toLowerCase(), Q, {
							...
							r : [D, M, L.width, L.height, j, L.right, n, s, y,
									y, N],
							b : [D, M, L.width, L.height, h, L.bottom, n, s, y,
									F, N],
							tl : [D, M, 0, 0, y, y, m, l, K, F, N],
							bl : [D, M, 0, 0, h, L.y + L.height, m, s, K, F, N],
							br : [D, M, 0, 0, a, [L.right, L.bottom], n, s, K,
									F, N],
		...
		highlight : function(D, H) {
			...
			F.queueFx(H, function() {
						...
						arguments.callee.anim = p(G).fxanim(C, H, "color", 1,
								"easeIn", I)
					});
			return F
		},
...
(function() {
	...
	Ext.extend(Ext.data.Connection, Ext.util.Observable, {
			...
			if (s.fireEvent(b, s, n)) {
				if (n.el) {
					if (!Ext.isEmpty(n.indicatorText)) {
						s.indicatorText = '<div class="loading-indicator">'
								+ n.indicatorText + "</div>"
					}
					if (s.indicatorText) {
						Ext.getDom(n.el).innerHTML = s.indicatorText
					}
					n.success = (Ext.isFunction(n.success)
							? n.success
							: function() {
				...
				l = Ext.urlEncode(s.extraParams, Ext.isObject(l) ? Ext
								.urlEncode(l) : l);
				if (Ext.isFunction(k)) {
				...
				j = n.method || s.method
						|| ((l || n.xmlData || n.jsonData) ? i : a);
				if (j === a && (s.disableCaching && n.disableCaching !== false)
						|| n.disableCaching === true) {
		...
		doFormUpload : function(q, j, k) {
			var l = Ext.id(), v = document, r = v.createElement("iframe"), m = Ext
					.getDom(q.form), u = [], t, p = "multipart/form-data", n = {
				target : m.target,
				method : m.method,
				encoding : m.encoding,
				enctype : m.enctype,
			...
			function s() {
				...
				try {
					A = r.contentWindow.document || r.contentDocument
							|| g.frames[l].document;
					if (A) {
						if (A.body) {
							if (/textarea/i
									.test((z = A.body.firstChild || {}).tagName)) {

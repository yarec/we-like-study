...
class install_yf2jj2kj2zckj2jjf extends wls {
	...
	public $ids_level_knowledge = array('52050401','52050402','52050403','52050404','52050405');

	public $id_level_subject = '520504';
	function install_yf2jj2kj2zckj2jjf(){
		parent::wls();
		$this->types = array(
			'520504'=> array(
				'su_id'=>6
...
var down = function(){
	$.ajax({
		type: 'post',
		url: 'wls.php?controller=install_yf2jj2kj2zckj2jjf&action=down',
		data: {id:ids[index]},

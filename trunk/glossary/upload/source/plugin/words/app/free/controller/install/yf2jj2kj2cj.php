...
class install_yf2jj2kj2cj extends wls {
	...
	public $id_level_subject = '520201';
	function install_yf2jj2kj2cj(){
		parent::wls();
		$this->types = array(
			'520201'=> array(
				'su_id'=>6
...
var down = function(){
	$.ajax({
		type: 'post',
		url: 'wls.php?controller=install_yf2jj2kj2cj&action=down',
		data: {id:ids[index]},
...
<div id=\"console\"><div>
	...
	public function getQuestions(){
		...
		$this->up = "判断题";
		$this->down = array("填空题","计算题","简答题","操作题","计算分析题");
		$question = array(
			 'id_quiz'=>$this->id_quiz
			,'title'=>'判断题'
			,'type'=>'大题'

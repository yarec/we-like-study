...
class install_yf2jj2kj2zckj2kj extends wls {
	...
	public $ids_level_knowledge = array('52050301','52050302','52050303','52050304','52050305');

	public $id_level_subject = '520503';
	function install_yf2jj2kj2zckj2kj(){
		parent::wls();
		$this->types = array(
			'520503'=> array(
				'su_id'=>6
...
var down = function(){
	$.ajax({
		type: 'post',
		url: 'wls.php?controller=install_yf2jj2kj2zckj2kj&action=down',
		data: {id:ids[index]},

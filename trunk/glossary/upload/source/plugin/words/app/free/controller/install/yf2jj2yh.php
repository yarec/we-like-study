...
class install_yf2jj2yh extends wls {
	...
	public $ids_level_knowledge = array(
		'5304'=>array('530451','530452','530453','530454','530455'),
		'5303'=>array('530351','530352','530353','530354','530355'),
		'5305'=>array('530551','530552','530553','530554','530555'),
		'5302'=>array('530251','530252','530253','530254','530255'),
		'5301'=>array('530151','530152','530153','530154','530155'),
	);

	public $id_level_subject = '5305';
	function install_yf2jj2yh(){
		parent::wls();
		$this->types = array(
			'5304'=> array(
				'su_id'=>6
...
var down = function(){
	$.ajax({
		type: 'post',
		url: 'wls.php?controller=install_yf2jj2yh&action=down',
		data: {id:ids[index]},
...
<div id=\"console\"><div>
	...
	public function getCheckQuestions(){
		...
		for($i=($startPoint+1);$i<=($endPoint+1);$i++){
			...
			$question = array(
				...
				,'index' =>"10".( ($i>9)?$i:('0'.$i) )
				,'ids_level_knowledge'=>$this->ids_level_knowledge[$this->id_level_subject][rand(0,4)]
				,'type2'=>'判断题'
			);
	...
	public function getQuestions(){
		...
		$this->up = "判断题";
		$this->down = "FFFFFFFFFFFFFFFFFFFFFFFFFF";
		$question = array(
			 'id_quiz'=>$this->id_quiz
			,'title'=>'判断题'
			,'type'=>'大题'

...
/**
 * The WLS system have it's own authentication module,
 * Including User , UserGroup , Permissions and so on.
 * To make the WLS comunicate with Joomla and other CMS, 
 * just make a bridge , then synchro the main authentication data from CMS to WLS
 * */
interface integrate{	

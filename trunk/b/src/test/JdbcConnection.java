...
/**
* 数据库连接工具类，使用Access时需要配合FilePathUtil类使用
* @author KyLinD 2009-05-06 http://hi.baidu.com/kylind
* @version 1.0
*/
public class JdbcConnection {
    // 定义线程本地变量，每个线程访问它都会获得不同的对象
    // 使用ThreadLocal使一个连接绑定到一个线程上
    public  ThreadLocal<Connection> currentConnection = new ThreadLocal<Connection>();
    public  String username="system";    //用户名，都有效
    public  String password="admin";        //密码，都有效
    public  String dbName="orcl";        //数据库名称，access无效
    public  String ip="127.0.0.1";        //数据库服务器IP地址，access无效
    public  String dataPath = "/dbName.mdb";    //access有效
    public  String resourceName=null;    //为null时不使用连接池，或者起名 jdbc/mysql，或者jdbc/oracle，或者jdbc/access，或者jdbc/derby
    public  String databaseType = "mysql";    //四个值：access mysql oracle derby ，必须设定
    /**
     * 
     * @return 得到一个数据库连接
     * @throws SQLException

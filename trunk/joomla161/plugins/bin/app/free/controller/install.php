...
//		$obj->importExcelWithUser($this->c->filePath."demodata/config.xls");
//		$obj->importExcelWithSubject($this->c->filePath."demodata/config.xls");
//		$obj->importExcelWithAccess($this->c->filePath."demodata/config.xls");
...
//		exit();
	...
	public function installDemoData(){
		...
		$folder = $this->c->filePath.'demodata/'.$this->c->language.'/paper/';
		...
		if(isset($_REQUEST['id'])){
			...
			$file = $this->c->filePath.'demodata/'.$this->c->language.'/config.xls';
			$obj = new m_user_group();
			...
			$files = $this->t->getAllFiles($folder);
...
<div id='data'><div>
	...
	public function installDemoExam(){
		$folder = $this->c->filePath.'demodata/'.$this->c->language.'/exam/';
		$obj = new m_quiz_exam();
...
<div id='data'><div>
	...
	public function installDemoQuizLog(){
		$folder = $this->c->filePath.'demodata/'.$this->c->language.'/log/';
		$obj = new m_quiz_log();

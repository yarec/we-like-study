...
class install_yf2jj2zj extends wls {
	...
	public $id_level_subject = '540103';
	function install_yf2jj2zj(){
		parent::wls();
		$this->types = array(
			'540101'=> array(
				'su_id'=>6
			...
			'540103'=> array(
				'su_id'=>6
				,'mainfolder'=>'f经济f'
				,'path'=>"E:/Projects/WEBS/PHP/phpwind_UTF8_8_3/upload/apps/wls/app/free/controller/install/f经济f/f模拟题f/f证券业从业资格考试f/f证券市场基础知识f" 
			),
			'540104'=> array(
				'su_id'=>6
				,'mainfolder'=>'f经济f'
				,'path'=>"E:/Projects/WEBS/PHP/phpwind_UTF8_8_3/upload/apps/wls/app/free/controller/install/f经济f/f模拟题f/f证券业从业资格考试f/f证券投资分析f" 
			),		
			'540105'=> array(
				'su_id'=>6
				,'mainfolder'=>'f经济f'
				,'path'=>"E:/Projects/WEBS/PHP/phpwind_UTF8_8_3/upload/apps/wls/app/free/controller/install/f经济f/f模拟题f/f证券业从业资格考试f/f证券投资基金f" 
			),					
		);
	}
...
var down = function(){
	$.ajax({
		type: 'post',
		url: 'wls.php?controller=install_yf2jj2zj&action=down',
		data: {id:ids[index]},
...
<div id=\"console\"><div>
	...
	public function getQuestions(){
		...
		$this->down = array("多选题","多项选择题","不定项选择题");
		$question = array(
			 'id_quiz'=>$this->id_quiz
			,'title'=>'单项选择题'
			,'type'=>'大题'
		...
		$this->up = array("多选题","多项选择题","不定项选择题");
		$this->down = "判断题";
		$question = array(
			 'id_quiz'=>$this->id_quiz
			,'title'=>'多项选择题'

...
class install_yf2jj2kj2zckj2sf extends wls {
	...
	public $ids_level_knowledge = array('52050601','52050602','52050603','52050604','52050605');

	public $id_level_subject = '520506';
	function install_yf2jj2kj2zckj2sf(){
		parent::wls();
		$this->types = array(
			'520506'=> array(
				'su_id'=>6
...
var down = function(){
	$.ajax({
		type: 'post',
		url: 'wls.php?controller=install_yf2jj2kj2zckj2sf&action=down',
		data: {id:ids[index]},

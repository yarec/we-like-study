...
class install_yf2jj2kj2zj extends wls {
	...
	public $id_level_subject = '520303';
	function install_yf2jj2kj2zj(){
		parent::wls();
		$this->types = array(
			'520301'=> array(
				'su_id'=>6
...
var down = function(){
	$.ajax({
		type: 'post',
		url: 'wls.php?controller=install_yf2jj2kj2zj&action=down',
		data: {id:ids[index]},

...
opacity:1});}
$this.focus(function(){
$getAltBox().css("opacity",0.3);}).blur(function(){
...
isURL:function(){
return(new RegExp(/^[a-zA-z]+:\/\/(\w+(-\w+)*)(\.(\w+(-\w+)*))*(\?\S*)?$/).test(this));}});})(jQuery);
function Map(){
...
jGroups.hide().eq(op.currentIndex).show();}}}});})(jQuery);(function($){
...
break;}}};})(jQuery);
var allSelectBox=[];(function($){
$.extend($.fn,{
selectBox:function(options){
var op=$.extend({
selector:">a",
styleClass:"selected"},options);
return this.each(function(){
$(">li",$(this)).select(op);});},

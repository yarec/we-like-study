...
class m_quiz_paper_yf_p2 extends m_quiz_paper_yf implements yfActions{	
	
	public $checkLength = 10;
	public $choiceLength = 15;
	public $multiChoiceLength = 10;

	public function getPaper(){
		$title = '会计_中级_会计实务'.rand(1,100);
		if($this->yfnum!=null){
			$title = $this->yfnum.'会计_中级_会计实务';
		}
		$data = array(
			 'id_level_subject'=>'1102'
			,'name_subject'=>'会计实务'
			,'title'=>$title
			,'description'=>'会计实务'.rand(1,100)
			,'creator'=>'admin'
